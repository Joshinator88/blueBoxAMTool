    ...
    <div class="flex space-x-4 p-4">
        ...
        <div class="w-1/3 bg-white shadow-md rounded p-4">
            ...
            <form method="GET" action="/parents/search" enctype="multipart/form-data" class="mb-4">
                @csrf
                <div class="flex">
                    <input class="rounded-l-md border-blue-300 w-10/12 p-2" type="text" id="parentSearch" name="parentSearch" placeholder="Search parents...">
                    <button type="submit" class="rounded-r-md bg-blue-500 w-2/12 text-white hover:cursor-pointer hover:bg-blue-400 flex items-center justify-center">
            ...
            <div class="mt-8 mb-3 bg-white p-5 pb-5 rounded-md">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('parents.show', $parent->id) }}" class="text-blue-500">{{ $parent->name }}</a>
                    </li>
                    @endforeach
                </ul>
                @else
        ...
        <div class="w-1/3 bg-white shadow-md rounded p-4">
            ...
            <form method="POST" action="{{ route('parents.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full rounded-md border-blue-300 p-2" id="name" name="name" type="text" placeholder="Name (required)">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="checkbox" id="{{ $partner->name }}" name="partners[]" value="{{ $partner->id }}">
                    <label for="{{ $partner->id }}"> {{ $partner->name }}</label>
                    @endforeach
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="salesOne">Sales agent one</label>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="salesTwo">Sales agent two</label>
        ...
        <div class="w-1/3 bg-white shadow-md rounded p-4">
            ...
            <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="category_name">Name</label>
